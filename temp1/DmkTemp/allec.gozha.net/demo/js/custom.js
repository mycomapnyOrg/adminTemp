...
document.addEventListener("DOMContentLoaded", function() {
  // Adding style-editor.css file in DOM
    var styles = document.createElement('link');
    styles.rel = "stylesheet";
    styles.href = "css/style-editor3860.css?v=1";
    ...
    var scriptEditor = document.createElement('script');
    scriptEditor.src = "js/style-editor.js";
