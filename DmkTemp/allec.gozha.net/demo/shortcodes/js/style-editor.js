...
global = (function(global) {
    ...
    var defaultValues = ['#34495e', '#85d6de', '#fed37f', '#fe8f8c', '#737c85', '#ffffff', 'Varela Round', 'Open Sans'];
    ...
    var StyleEditor = function() {
        ...
        overlayText.textContent = 'Your styles is sending...';
    ...
    Object.defineProperties(StyleEditor.prototype, {
        ...
        _submitForm: {
            value: function (e, makeXHRRequestFunc) {
                ...
                setTimeout(function() {
                    global.overlay.firstElementChild.textContent = 'Waiting response from server...';
                }, 800);
        ...
        _receive: {
            value: function (req) {
                ...
                global.overlay.addEventListener('animationend', function animEndOverlay(e) {
                    ...
                    global.overlay.firstElementChild.textContent = 'Your styles is sending...';
...
var global = (function(global) {
    ...
    for (var i = 0, max = colorInputs.length; i < max; i++) {
        ...
        colorSamples[i].addEventListener('click', showPicker);
    ...
    function convertColorFromInput(e) {
        ...
        var regHEX = /^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/;
        if (target.value == picker.hex || '#' + target.value == picker.hex || regHEX.test(targetValue)) {
            return;
        }
