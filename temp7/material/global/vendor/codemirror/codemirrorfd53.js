...
{rect=nullRect;}}
var rtop=rect.top- prepared.rect.top,rbot=rect.bottom- prepared.rect.top;var mid=(rtop+ rbot)/ 2;
var heights=prepared.view.measure.heights;var i=0;for(;i<heights.length- 1;i++)
...
var anchor=elt("span","xxxxxxxxxx");var pre=elt("pre",[anchor]);removeChildrenAndAdd(display.measure,pre);var rect=anchor.getBoundingClientRect(),width=(rect.right- rect.left)/ 10;
...
var type;if(ch==0){type=styles[2];}
