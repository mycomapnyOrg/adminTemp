...
async componentDidMount(){
 ...
 var colorArray = JSON.parse(await AsyncStorage.getItem("colorArray"));
    this.setState({url:url,initroute:initroute,themebgcolor:themebgcolor,menuLable:this.props.menuLable,applogo:applogo,colorArray:colorArray});
	...
	var url =_this.state.url;
		...
		"Response Body -> " + JSON.stringify(responseData)
			...
			if(responseData!=""){
				...
				_this.setState({
                               eventsDetails:responseData,isVisible:false,retry:false,animating:false
				});
...
if(_this.state.resultData==true){
	...
	if(this.state.retry==true){
	 ...
	 if(this.state.initroute=='MainMenu'){
			...
			var Archive=<View style={ThemeStyles.cardStyle} >            
		<TouchableOpacity  onPress={()=>this.navigate('Archive')}>
		<Text style={styles.questionaday}>Archived</Text>
		</TouchableOpacity>				
		</View>;
			...
			headerTab= <View style={ThemeStyles.hederBGTheme1}>
			 ...
			 Archive=<View style={ThemeStyles.cardStyleTheme1} >            
		<TouchableOpacity  onPress={()=>this.navigate('Archive')}>
		<Text style={ThemeStyles.questionadayTheme1}>Archived</Text>
		</TouchableOpacity>				
		</View>;
		}
        else if(this.state.initroute=='Theme2'){
            ...
            Archive=<View style={ThemeStyles.cardStyleTheme22} >
            <TouchableOpacity  onPress={()=>this.navigate('Archive')}>
            <Text style={ThemeStyles.questionadayTheme1}>Archived</Text>
            </TouchableOpacity>
            </View>;
			...
			Archive=<View style={ThemeStyles.cardStyleTheme3} >            
		<TouchableOpacity  onPress={()=>this.navigate('Archive')}>
		<Text style={ThemeStyles.questionadayTheme3}>Archived</Text>
		</TouchableOpacity>				
		</View>;
		}
