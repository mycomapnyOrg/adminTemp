		...
		<View style={styles.avatarContainerhead}>
			<TouchableOpacity activeOpacity={.3}   onPress={() => that.rowPressed(menuarray.menuurl,menuarray.menu)} >
				<View style={styles.containerStyle}>
					<View style={{ width: that.state.imageheight,height: that.state.imageheight, alignItems: 'center',   backgroundColor:menuarray.color  , borderRadius: 5, }}   >
	 ...
	 logout=<View style={{alignSelf:'flex-start'}}>
      ...
      const animating = this.state.animating
	   ...
	   return (
		...
		<View style={{  flex: 1,width:this.state.width,height:this.state.height,   backgroundColor: this.state.themebgcolor}} onLayout={(event) => this.handleLayoutChange(event)}>
